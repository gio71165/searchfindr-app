    ...
    <main className="min-h-screen bg-[#F9FAFB] dark:bg-slate-900">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-lg border border-slate-200 dark:border-slate-700 shadow-sm p-8">
          ...
          <p className="text-slate-600 dark:text-slate-400 mb-8">Settings page coming soon.</p>

          <div className="space-y-4">
            <div className="p-4 bg-slate-50 dark:bg-slate-700/50 rounded-lg">
              <h2 className="font-semibold text-slate-900 dark:text-slate-100 mb-1">Future Settings</h2>
