      ...
      <div className="space-y-4 text-sm text-slate-700">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-slate-600">7 full days of access to all features. No restrictions, no limits during your trial.</p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="font-semibold text-slate-900 mb-1">The Charge</p>
            <p className="text-slate-600">
              After 7 days, the selected plan ($79/month for Starter or $179/month for Pro) will be billed to the card on file. 
              <span className="font-semibold text-slate-900"> You won't be charged until Day 8.</span>
            </p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="font-semibold text-slate-900 mb-1">The Reminder</p>
            <p className="text-slate-600">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="font-semibold text-slate-900 mb-1">The Exit</p>
            <p className="text-slate-600">
              No "call to cancel" games. There's a <span className="font-semibold text-slate-900">"Cancel Subscription"</span> button in your settings that works instantly. 
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="font-semibold text-slate-900 mb-1">Refunds</p>
            <p className="text-slate-600">
              We offer a <span className="font-semibold text-slate-900">30-day money-back guarantee</span> even after the first charge if you aren't satisfied. 
