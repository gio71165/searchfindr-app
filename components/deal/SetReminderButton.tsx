      ...
      {showModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
            <h2 className="text-xl font-semibold mb-4 text-gray-900">Set Reminder</h2>
            ...
            <div className="mb-4">
              ...
              <input
                ...
                className="w-full border border-gray-300 bg-white text-gray-900 rounded-lg px-3 py-2"
              />
            </div>
